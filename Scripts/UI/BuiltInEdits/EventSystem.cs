/*
An EventSystem edit that reintroduces the lastSelectedGameObject accessor, which is officially deprecated. 
Search for '#region' to locate the modified segments.
*/
using System;
...
namespace UnityEngine.EventSystems
{
    ...
    public class EventSystem : UIBehaviour
    {
        ...
        #region lastSelectedGameObject reintroduction
        ...
        #endregion lastSelectedGameObject reintroduction
        ...
        public void SetSelectedGameObject(GameObject selected, BaseEventData pointer)
        {
            ...
            #region lastSelectedGameObject reintroduction
            _lastSelectedGameObject = m_CurrentSelected;
            #endregion lastSelectedGameObject reintroduction
