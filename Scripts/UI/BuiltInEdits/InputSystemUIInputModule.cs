/*
An InputSystemUIInputModule edit that fixes the issue of selection being set to null when clicking 
non-interactable Selectables with any mouse button. 
Solution found by WilsonCWong:
https://discussions.unity.com/t/feature-request-option-to-disable-deselect-in-ui-input-module/761974/25
Search for '#region' to locate the modified segment.
*/
    ...
    public class InputSystemUIInputModule : BaseInputModule
    {
        ...
        private void ProcessPointerButton(ref PointerModel.ButtonState button, PointerEventData eventData)
        {
            ...
            if (button.wasPressedThisFrame)
            {
                ...
                #region Unintended Deselection Fix
                ...
                // if (selectHandler != eventSystem.currentSelectedGameObject && (selectHandler != null || m_DeselectOnBackgroundClick))
                //     eventSystem.SetSelectedGameObject(null, eventData);
                #endregion Unintended Deselection Fix
